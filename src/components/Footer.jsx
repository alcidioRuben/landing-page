      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          >
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">LacasaDigital</span>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Transformamos sonhos em realidade através do conhecimento em dropshipping e Digital Marketing. 
              Nossa missão é democratizar o acesso ao conhecimento sobre negócios online.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              © {currentYear} LacasaDigital. Todos os direitos reservados.
            </motion.div>
